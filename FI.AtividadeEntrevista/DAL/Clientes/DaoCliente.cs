...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal bool VerificarExistencia(string CPF, long Id)
        {
            ...
            DataSet ds = base.Consultar("FI_SP_VerificaClienteCpfId", parametros);
        ...
        private List<DML.Cliente> Converter(DataSet ds)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    cli.Beneficiarios = ObterBeneficiariosDoCliente(row.Field<long>("Id"));
        ...
        internal List<DML.Beneficiario> ObterBeneficiariosDoCliente(long idCliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("Id", idCliente));

            DataSet ds = base.Consultar("FI_SP_ConsBenefPorCli", parametros);
